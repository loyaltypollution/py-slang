...
import { InstructionBuilder } from "./compiler-monad";
import { Program, Instruction, Argument, SVMFunction } from "./svml-compiler";
...
function compileCallExpression(
  ...
  return {
    maxStackSize: Math.max(functionStackEffect, maxArgStackSize, 1)
  };
}
...
/**
 * Compile a statement - direct, no monads
 */
...
/**
 * Compile a block of statements - direct, no monads
 */
