...
// Drain without transforms so the AST shape stays stable for assertions that
// dereference `fn.body[...]`. Transforms (dead-store, dead-branch, ...) can
// rewrite the body post-analysis, which is orthogonal to what this test is
// verifying.
