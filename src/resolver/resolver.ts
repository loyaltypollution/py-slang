  ...
  constructor(source: string, ast: Stmt) {
    ...
    this.environment = new Environment(
      ...
      new Map([
        ...
        [
          "_int_from_string",
          new Token(TokenType.NAME, "_int_from_string", 0, 0, 0),
        ],
        ...
        [
          "math_factorial",
          new Token(TokenType.NAME, "math_factorial", 0, 0, 0),
        ],
        ...
        [
          "math_nextafter",
          new Token(TokenType.NAME, "math_nextafter", 0, 0, 0),
        ],
        ...
        [
          "math_remainder",
          new Token(TokenType.NAME, "math_remainder", 0, 0, 0),
        ],
