...
export class BuiltInFunctions {
  ...
  static error(
    ...
    const output =
      "Error: " +
      args.map((arg) => BuiltInFunctions.toStr(arg)).join(" ") +
      "\n";
  ...
  static math_acos(
    ...
    if (num < -1 || num > 1) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_acos"),
      );
    }
  ...
  static math_acosh(
    ...
    if (num < 1) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_acosh"),
      );
    }
  ...
  static math_asin(
    ...
    if (num < -1 || num > 1) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_asin"),
      );
    }
  ...
  static math_atanh(
    ...
    if (num <= -1 || num >= 1) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_atanh"),
      );
    }
  ...
  static math_erfc(
    ...
    const erfc =
      1 - BuiltInFunctions.math_erf(args[0], source, command, context).value;
  ...
  static math_comb(
    ...
    if (n.type !== "bigint") {
      handleRuntimeError(
        context,
        new TypeError(source, command as es.Node, context, n.type, "int"),
      );
    } else if (k.type !== "bigint") {
      handleRuntimeError(
        context,
        new TypeError(source, command as es.Node, context, k.type, "int"),
      );
    }
    ...
    if (nVal < 0 || kVal < 0) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_comb"),
      );
    }
  ...
  static math_gcd(
    ...
    for (let i = 1; i < values.length; i++) {
      currentGcd = BuiltInFunctions.gcdOfTwo(
        currentGcd,
  ...
  static math_isqrt(
    ...
    if (n < 0) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_isqrt"),
      );
    }
  ...
  static math_lcm(
    ...
    for (let i = 1; i < values.length; i++) {
      currentLcm = BuiltInFunctions.lcmOfTwo(
        currentLcm,
        BuiltInFunctions.absBigInt(values[i]),
      );
  ...
  static math_perm(
    ...
    if (n < 0 || k < 0) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_perm"),
      );
    }
  ...
  static math_fmod(
    ...
    if (yVal === 0) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_fmod"),
      );
    }
  ...
  static math_log(
    ...
    if (num <= 0) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_log"),
      );
    }
  ...
  static math_log10(
    ...
    if (num <= 0) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_log10"),
      );
    }
  ...
  static math_log1p(
    ...
    if (1 + num <= 0) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_log1p"),
      );
    }
  ...
  static math_log2(
    ...
    if (num <= 0) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_log2"),
      );
    }
  ...
  static math_sqrt(
    ...
    if (num < 0) {
      handleRuntimeError(
        context,
        new ValueError(source, command as es.Node, context, "math_sqrt"),
      );
    }
    ...
    if (numArg.type === "number") {
      ...
      if (ndigitsArg.value >= 0) {
        ...
        const shifted: bigint =
          (numArg.value / BigInt(10) ** -ndigitsArg.value) *
          BigInt(10) ** -ndigitsArg.value;
...
export function toPythonString(obj: Value): string {
  ...
  if ((obj as Value).type === "bigint" || (obj as Value).type === "complex") {
    ...
    (obj as Value) === undefined ||
    (obj as Value).value === undefined
  ) {
    ret = "None";
  } else {
    ret = (obj as Value).value.toString();
